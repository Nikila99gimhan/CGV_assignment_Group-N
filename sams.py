...
# Function to get an adaptive binary image
...
# Function to get external contours
...
def process_image(filename):
    ...
    sample = cv2.imread("./Samples/" + filename)
    filename = filename.split(".")[0]
    print('[ Step 1 ] Image Read Completed!')

    # Getting Started
    print("[ Step 2 ] Scaling Image...")
    scale_percent = 40
    ...
    print("[ Step 2 ] Scaling Image Completed")

    print("[ Step 3 ] Binarizing, GreyScaling and Rotating Image...")
    binary_image = get_adaptive_binary_image(resized)
    utils.compareBoundingSizeimage_with_contours, img_binary_sheet_rotated = utils.rotated_sheet(resized, binary_image)
    ...
    print("[ Step 3 ] Binarizing, GreyScaling and Rotating Image Completed!")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python sams.py <image_filename>")
    else:
        filename = sys.argv[1]
